  ...
  return (
    <>
      ...
      <motion.div 
        ...
        className="absolute right-0 sm:-right-4 top-12 w-[calc(100vw-2rem)] sm:w-[320px] md:w-[420px] max-w-[420px] bg-elevated border border-outline shadow-2xl rounded-2xl z-50 overflow-hidden flex flex-col max-h-[85vh] origin-top-right mr-4 sm:mr-0"
      >
        {/* Header */}
